...
% % xq = [1:1:48];
% % v = [1.05, 1.01, 1.023, 1, 0.95, 0.955, 0.96, 0.974, 0.98, 0.98, 0.976, 0.974, 0.97,  1, 1.01,  1];
% 
...
%         disp('working 2')
        ...
        obj = (eta'*p + kappa*(p'*p)) +...
              (step_size/(n_deg(i)*4))*norm( (1/step_size)*(Psi{i}*(x/1000) - (1/N)*w) - (1/step_size)*nu_old(:,i) +  temp)^2;
...
% 
% subplot(3,1,2)
% plot(real_power{1}, 'rx-')
% hold on
% plot(u(1:T,1), 'go--')
% 
% subplot(3,1,3)
% plot(reac_power{1}, 'rx-')
% hold on
% plot(u(T+1:2*T,1), 'go--')
